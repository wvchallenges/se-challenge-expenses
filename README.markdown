...
The front end web application and backend Django server are separate. This is a very clean and minimal approach to solve the problem. The expense API is generated by by Django REST Swagger, and the file upload endpoint implements Django Parsers to process the data.
