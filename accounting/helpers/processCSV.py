...
def process_csv(uploaded_file):
    ...
    # Here, we should check if all expected columns exist, if not raise an exception.
    # I haven't done this for the challenge, but it should definitely be done for an app in production.
    ...
    # This assumes that employee name and address cannot contain a missing value in any tuple. If missing values are present
    # in any tuple containing these attributes, the tuple will be dropped before the merge operation.
