...
describe('Wave Challenge', function() {
  describe('#csvimport()', function() {
    it('verify output provides expected results with provided input data', function() {
      console.log("verify output provides expected results with provided input data\n", ob.challenge1(c1DataInput));
      assert.equal("bond,benchmark,spread_to_benchmark\nC1,G1,1.60%\n", ob.challenge1(c1DataInput));
    });
  });
});